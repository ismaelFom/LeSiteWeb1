        ...
        <div className="row g-5">
            <div className="col-lg-7">
                <div className="section-title position-relative pb-3 mb-5">
                    ...
                    <h1 className="mb-0">The Best IT Solution With 5 Years of Experience</h1>
                </div>
                ...
                <div className="row g-0 mb-3">
                    <div className="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                        <h5 className="mb-3"><BsCheckLg style={{width: '50px', height: '50px', color: '#091E3E'}}/>Award Winning</h5>
                ...
                <Link to="quote.html" className="btn btn-warning py-3 px-5 mt-3 wow zoomIn" data-wow-delay="0.9s">Request A Quote</Link>
            </div>
