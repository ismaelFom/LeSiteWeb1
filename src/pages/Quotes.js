                ...
                <div className="row g-5">
                    <div className="col-lg-7">
                        <div className="section-title position-relative pb-3 mb-5">
                            <h5 className="fw-bold text-warning text-uppercase">Request A Quote</h5>
                            <h1 className="mb-0">Need A Free Quote? Please Feel Free to Contact Us</h1>
                        </div>
                        <div className="row gx-3">
                            <div className="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                                <h5 className="mb-4"><IoReturnUpBack style={{width: '30px', height: '30px',padding: '2px', color: '#091E3E'}}/>Reply within 24 hours</h5>
                            </div>
                            <div className="col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                                <h5 className="mb-4"><BsTelephone style={{width: '20px', height: '20px',padding: '2px', color: '#091E3E'}}/>24 hrs telephone support</h5>
                            </div>
                        </div>
                    ...
                    <div className="col-lg-5">
                        <div className="bg-warning rounded h-100 d-flex align-items-center p-5 wow zoomIn" data-wow-delay="0.9s">
                            <form>
